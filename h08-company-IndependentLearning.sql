...
from (select salary from Employee order by salary)
where rownum < 5;
--
/*(130) TOP-N query.
...
SELECT DENSE_RANK(30000) WITHIN GROUP 
   (ORDER BY salary) "Dense Rank of 30000" 
   FROM Employee;
-- 
...
SELECT DENSE_RANK(31000) WITHIN GROUP 
   (ORDER BY salary) "Dense Rank of 31000" 
   FROM Employee;
--
